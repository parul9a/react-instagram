import { Flex, GridItem, Text, Image, Modal, ModalOverlay, ModalContent, ModalCloseButton, ModalBody, Avatar, Divider, VStack, Button } from '@chakra-ui/react'
                        ...
                        <Flex flex={1} flexDir={"column"} px={10} display={{ base: "none", md: "flex" }}>
                            <Flex alignItems={"center"} justifyContent={"space-between"}>
                                <Flex alignItems={"center"} gap={4}>
                                    <Avatar src={'/profilrpic.img'} size={"sm"} name='As a Programmer' />
                            ...
                            <VStack w='full' alignItems={"start"} maxH={"350px"} overflowY={"auto"}>
                                <Comments createdAt="1d ago" username="aaa" profilePic="/profilepic.png" text="Dummy Text"/>
                                <Comments createdAt="1d ago" username="aaa" profilePic="/profilepic.png" text="Dummy Text"/>
                                <Comments createdAt="1d ago" username="aaa" profilePic="/profilepic.png" text="Dummy Text"/>
                            </VStack>
